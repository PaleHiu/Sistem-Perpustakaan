    ...
    <div class="container">
        ...
        <div class="login-section">
            ...
            <div class="glass-card {{ old('form_type') == 'register' ? 'hidden' : '' }}" id="loginCard">
                ...
                <div class="card-footer-left" style="text-align: center; margin-bottom: 0px;">
                    <p style="margin: 0;"><i>Forgot your password?</i>
                        <a href="{{ route('sipus.forgot.password') }}" style="color: #1fcf8e; text-decoration: underline; font-weight: bold;">
                            Reset here
                        </a>
                    </p>
                </div>
